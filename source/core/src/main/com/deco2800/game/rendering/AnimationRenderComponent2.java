 ...
 */
public class AnimationRenderComponent2 extends RenderComponent {
  private static final Logger logger = LoggerFactory.getLogger(AnimationRenderComponent2.class);
   ...
   */
  public AnimationRenderComponent2(TextureAtlas atlas) {
    this.atlas = atlas;
