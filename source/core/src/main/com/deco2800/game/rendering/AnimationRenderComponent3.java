 ...
 */
public class AnimationRenderComponent3 extends RenderComponent {
    private static final Logger logger =
            LoggerFactory.getLogger(AnimationRenderComponent3.class);
     ...
     */
    public AnimationRenderComponent3(TextureAtlas atlas) {
        this.atlas = atlas;
